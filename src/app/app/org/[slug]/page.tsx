...
import AppShellComp from "@/components/layout/AppShell";
...
export default function OrgPageClient() {
  ...
  return (
    <AppShellComp>
      {/* WRAPPER: adds vertical rhythm between sections */}
